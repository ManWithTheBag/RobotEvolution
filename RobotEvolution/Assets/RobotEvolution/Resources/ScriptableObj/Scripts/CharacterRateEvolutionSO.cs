...
public class CharacterRateEvolutionSO : ScriptableObject
{
    ...
    public int Level_2
    {
        ...
        private set
        {
            ...
            {
                _level_2 = -999;
                Debug.LogError($"Error: CharacterRateEvolutionSo; Score for Level_2 < Level_1: {Level_2} < {Level_1}");
            }
        }
    }
    ...
    public int Level_3
    {
        ...
        private set
        {
            ...
            {
                _level_3 = -999;
                Debug.LogError($"Error: CharacterRateEvolutionSo; Score for Level_2 < Level_1: {Level_3} < {Level_2}");
            }
        }
    }
    ...
    public int Level_4
    {
        ...
        private set
        {
            ...
            {
                _level_4 = -999;
                Debug.LogError($"Error: CharacterRateEvolutionSo; Score for Level_2 < Level_1: {Level_4} < {Level_3}");
            }
        }
    }
    ...
    public int Level_5
    {
        ...
        private set
        {
            ...
            {
                _level_5 = -999;
                Debug.LogError($"Error: CharacterRateEvolutionSo; Score for Level_2 < Level_1: {Level_5} < {Level_4}");
            }
        }
    }
}
